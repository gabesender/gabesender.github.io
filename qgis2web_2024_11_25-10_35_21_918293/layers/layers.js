...
var lyr_ne_10m_airports_1 = new ol.layer.Vector({
    ...
    <img src="styles/legend/ne_10m_airports_1_1.png" /> Major Airp<br />\
    <img src="styles/legend/ne_10m_airports_1_2.png" /> Mid Airpor<br />\
    <img src="styles/legend/ne_10m_airports_1_3.png" /> Small Airp<br />'
        });
...
lyr_ne_10m_airports_1.set('fieldLabels', {'name': 'no label', 'iata_code': 'header label - always visible', 'wikipedia': 'no label', 'Type': 'no label', });
